...
type ShelfData = { id: string; position: number; bayCount: number | null; isOnline: boolean | null; bays: BayData[]; [key: string]: unknown };
type RackTopology = { id: string; name: string; location: string | null; shelves: ShelfData[]; [key: string]: unknown };
type RackSummary = { id: string; name: string; location: string | null; [key: string]: unknown };
            ...
            <CardContent>
              <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 1 }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                  ...
                  <Typography variant="h6" fontWeight={600}>{rack.name}</Typography>
                  {rack.location && (
                    <Typography variant="body2" color="text.secondary">{rack.location}</Typography>
                  )}
                </Box>
